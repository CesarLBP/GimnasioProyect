				...
				<div class="col-md-10 offset-md-2 card" style="padding:0;">
					...
					<div class="card-footer">
						...
						<?php 
							...
							Crear::botonEnviarAjax('botonRegistrar','btn btn-primary col-md-6 offset-md-3','login','prueba');
							//Crear::botonEnviar('Registrar','login','registrarUsuario','botonRegistrar','btn btn-primary col-md-6 offset-md-3');
						?>
