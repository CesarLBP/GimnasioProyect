...
values('Informatica'),('Electricidad'),('Electronica'),('Telecomunicaciones'),('Quimica'),('Procesos Quimicos'),('Administracion'),('Contaduria'),('Tecnologia de los Materiales'),('Mecatronica'),('Mecanica Industrial'),('Construccion Civil');
